...
local modf, min, max, abs, sin, floor, format, lerp = math.modf, math.min, math.max, math.abs, math.sin, math.floor, string.format, math.lerp;
...
function ArmStatic.set_padded_amount(text, amount, alt)
	...
	if alt > 0 then text:set_range_color(2,0, text:color():with_alpha(0.5))
